...
function s.fccondition(e)
	...
	return Duel.GetMatchingGroupCount(s.fcfllter,tp,LOCATION_ONFIELD,0,nil)>=3
end
...
function s.damop(e,tp,eg,ep,ev,re,r,rp)
	...
	local dam=2
	if Duel.GetMatchingGroupCount(s.fcfllter,tp,LOCATION_ONFIELD,0,nil)>=3 then dam=4 end

...
function Kirafan3.SpCreamateEff(c)
	...
	e6:SetDescription(aux.Stringid(10050111,8))
	e6:SetType(EFFECT_TYPE_QUICK_O)
	e6:SetCode(EVENT_FREE_CHAIN)
	e6:SetHintTiming(TIMING_BATTLE_START+TIMING_BATTLE_STEP_END+TIMING_CHAIN_END+TIMING_DAMAGE_CAL)
	e6:SetProperty(EFFECT_FLAG_DAMAGE_CAL)
	e6:SetRange(LOCATION_HAND)
	e6:SetCondition(Kirafan6.spcreamatecon)
	e6:SetTarget(Kirafan3.noeffecttg)
	c:RegisterEffect(e6)
	local e7=e6:Clone()
	c:RegisterEffect(e7)
end
